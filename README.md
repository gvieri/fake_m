...
## Introduction
Fake_m is a test project fro peoples that are interested to make test and play on a potentially real cryptocoin. 

SO: if you are interested in trading and make money this is not the right project. 
If you are interested in technical beahvoiur of the cryptocoin, probably you are in the right place. 
